...
<p>Se o procedimento acima for bem-sucedido, a imagem poderá ser visualizada no DockerHub, assim como na demonstração abaixo:</p>

<p align="center"><img src=".\images\dockerhub.png" width="60%"></img></p>

<p>Por meio <a href="https://hub.docker.com/repository/docker/amandafontes/curriculum_application/general">deste link</a>, é possível acessar o repositório que criei para a atividade.</p>

<h4>Estrutura de pastas</h4>

:file_folder: &nbsp; containerized_application
&nbsp; :file_folder: &nbsp; conteiner_environment
&nbsp; :file_folder: &nbsp; images
&nbsp; &nbsp; &nbsp; :file_folder: &nbsp; dockerhub.png
&nbsp; :file_folder: &nbsp; static
&nbsp; &nbsp; &nbsp; :file_folder: &nbsp; image.png
&nbsp; &nbsp; &nbsp; &nbsp; templates
